...
export default function BrowserMockup({
  ...
  return (
    ...
    <div className="w-full rounded-2xl overflow-hidden backdrop-blur-xl bg-white/5 border border-white/10 shadow-xl shadow-black/30">
      ...
      <div className={`flex items-center gap-3 px-4 py-3 bg-gradient-to-r ${accentGradient} border-b border-white/10`}>
        ...
        {/* URL bar */}
        <div className="flex-1 flex items-center gap-2 px-3 py-1.5 rounded-md bg-white/5 border border-white/10 min-w-0">
        ...
        {/* Reload icon */}
        <svg className="w-3.5 h-3.5 text-gray-500 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
      ...
      <div className="relative overflow-hidden bg-[#0d1117]">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-10 bg-gradient-to-t from-[#0d1117]/80 to-transparent pointer-events-none" />
      </div>
    </div>
  );
}
