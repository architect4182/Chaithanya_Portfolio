...
export default function BrowserMockup({
  ...
  return (
    /* Outer glass shell */
    <div className="w-full rounded-2xl overflow-hidden backdrop-blur-xl bg-surface border border-subtle shadow-xl shadow-black/30">

      {/* ── Browser chrome top bar ── */}
      <div className={`flex items-center gap-2 px-3 py-2 bg-gradient-to-r ${accentGradient} border-b border-subtle`}>
        ...
        {/* URL bar */}
        <div className="flex-1 flex items-center gap-2 px-2.5 py-1 rounded-md bg-surface border border-subtle min-w-0">
          ...
          <span className="text-[11px] text-content-secondary truncate font-mono">{url}</span>
        </div>

        {/* Reload icon */}
        <svg className="w-3 h-3 text-content-secondary shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
      ...
      <div className="relative overflow-hidden bg-background border-b border-subtle">
        <img
          src={imageSrc}
          alt={imageAlt}
